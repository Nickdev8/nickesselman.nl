...
<div class="card container separator split">
    <div>
...
<div class="card container separator">
    ...
    <div class="split">
        ...
        <img src="images/juice/partyvr.jpg" alt="PartyVR gameplay screenshot" class="img-cropped">
    </div>
    ...
    <div class="split">
        ...
        <img src="images/juice/storepage.jpg" alt="Unfinished PartyVR build" class="img-cropped-wide">
    </div>
</div>
...
<div class="card container separator" id="OpenCafe">
    ...
    <div class="split">
        ...
        <img src="images/juice/firstmeal.jpg" alt="Old buildings with new tech" class="img-cropped">
    </div>
    <div class="split">
        <p>

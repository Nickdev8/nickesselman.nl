...
<div class="card container separator" id="OpenCafe">
    ...
    <div class="split">
        ...
        <div>
            <img src="tourist-experience.jpg" alt="Locals taking pictures" class="img-cropped">
        </div>
    </div>
    <div class="split">
        <div>
        ...
        <div>
            <img src="making-juice.jpg" alt="Making juice with local fruits" class="img-cropped">
        </div>
    </div>
    <div class="split">
        <div>
        ...
        <div>
            <img src="old-new-buildings.jpg" alt="Old buildings with new tech" class="img-cropped">
        </div>
    </div>
    <div class="split">
        <div>
